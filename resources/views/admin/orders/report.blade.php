                        ...
                        <table dir="rtl" class="min-w-max w-full table-auto overflow-x-auto">
                            <thead>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm ">
                                    ...
                                    <th class="py-3 px-2  text-right">اجمالي التغذيات
                                        </th>
                                        <th class="py-3 px-2  text-right">{{ $veed_sum }}</th>
                                </tr>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm ">

                                    <th class="py-3 px-2  text-right">اجمالي المشتريات
                                        </th>
                                        <th class="py-3 px-2  text-right">{{ $pay_sum }}</th>
                                </tr>
                                <tr class="bg-gray-200 text-gray-600 uppercase text-sm hidden ">
