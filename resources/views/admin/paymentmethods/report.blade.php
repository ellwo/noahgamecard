                ...
                <div class="flex flex-wrap items-center">
                    <div class="relative w-full sm:px-4 max-w-full flex-grow sm:flex-1">
                        <h3 class="font-semibold relative mb-4 flex text-base text-blueGray-700">
                            {{__('اجمالي التغذيات عن طريق وسائل الدفع ')}}
                    ...
                    <div class="bg-white overflow-x-auto relative dark:bg-darker dark:text-white w-full shadow-md rounded my-6">
                        ...
                        <h4 class="text-right flex justify-items-center space-x-2" dir="rtl">من تأريخ
                            <input type="datetime-local"  wire:model.lazy='fromDate' class="bg-white  bg-white rounded-md text-dark  dark:text-white dark:bg-darker rounded-md border p-2"/>

                            </h4>

                        <h4 class="text-right flex justify-center space-x-2" dir="rtl">الى تأريخ

                            <input type="datetime-local"  wire:model.lazy='toDate' class="bg-white  bg-white rounded-md text-dark dark:text-white dark:bg-darker p-2 border"/>
                           </h4>
                        </div>
                        <table dir="rtl" class="min-w-max w-full table-auto overflow-x-auto">
                            <thead>
                                ...
                                <tr class="bg-gray-200 border text-gray-600 uppercase text-sm ">
                                ...
                                <tr class="">
                                    <th class="py-3 px-2  text-right">{{$p['name']}}
                                        </th>
                                        <th class="py-3 px-2  text-right">{{ $p['veed_sum'] }}</th>
                                </tr>
                                @endforeach
