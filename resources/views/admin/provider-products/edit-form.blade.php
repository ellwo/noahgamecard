<section>
    <div x-data="{step:1}"   class="items-center p-4 mx-auto max-w-5xl">
        ...
        <form action="{{ route('provider_products.update',$pr_product) }}" method="POST" class="bg-white rounded-lg dark:bg-darker" >
        ...
        <div class="p-6 mb-4 overflow-hidden flex justify-between text-2xl bg-blue-300 rounded-md shadow-md dark:bg-dark-eval-1">
            ...
            <x-button href="{{route('provider_products')}}">
                ...
                <div  class="space-y-4 text-center " x-show='step==1'>
                    ...
                    <label>
                      نشط
                    <input  type="radio" name="active" id="status"   @if($pr_product->active) checked @endif   value="1" />
                </label>
                <br>
                <label>
                    غير نشط
                    <input type="radio" name="active" id="status" @if(!$pr_product->active) checked @endif value="0" />
                </label>
                    </div>
                    ...
                    <label>
                      مباشر
                    <input  type="radio" name="direct" wire:model='direct' id="direct"  @if($pr_product->direct) checked @endif   value="1" />
                </label>
                <br>
                <label>
                    غير مباشر
                    <input type="radio" name="direct" id="direct" wire:model='direct' @if(!$pr_product->direct) checked @endif value="0" />
                </label>
                    </div>
                    ...
                    <div class="relative flex w-2/3 items-center justify-between space-x-4 space-y-2 ">
                        ...
                        <select wire:model='dispatch_at' id="dispatch_at" name="dispatch_at" class="w-4/5 mx-2 text-gray-600 bg-white border border-gray-300 rounded-md appearance-none sm:pl-5 sm:pr-10 sm:mx-0 dark:bg-darker dark:text-white hover:border-gray-400 focus:outline-none">
                ...
                <div  class=""  x-show="step==1">
                    <div class="grid gap-6 p-4 mb-6 lg:grid-cols-2">
                        <div>
                            ...
                            <input type="text"  value="{{ old('name',$pr_product->name) }}" name="name" id="first_name" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" required>

                        </div>
                        <div>
                            <label for="last_name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">السعر بحسب المزود</label>
                            <input type="text" name="price" value="{{ old('price',$pr_product->price) }}"  class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required>
                        </div>
                    ...
                    <div class="flex justify-between space-x-2">
                        ...
                        <div x-data="{reqcount:1}"
                            ...
                            @foreach ($pr_product->reqs??[] as $req)
                        ...
                        <div class="flex ">
                            ...
                            <div class="lg:flex  p-4 justify-between items-center border rounded-md space-x-2">
                                ...
                                <x-input name="reqname[]" value="{{$req['name']}}" required class=" p-2
